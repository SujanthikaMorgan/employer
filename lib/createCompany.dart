          ...
          SingleChildScrollView(
            child: Column(
              children: [
                ...
                Padding(
                  padding: EdgeInsets.only(right: 275, top: 15),
                  child: Text(
                    "Phone Number",
                    style: formtext,
                  ),
                ...
                Padding(
                  padding: EdgeInsets.only(right: 340, top: 15),
                  child: Text(
                    "Website",
                    style: formtext,
                  ),
                ...
                Padding(
                  padding: EdgeInsets.only(right: 325, top: 15),
                  child: Text(
                    "Facebook",
                    style: formtext,
                  ),
                ...
                Padding(
                  padding: EdgeInsets.only(right: 335, top: 15),
                  child: Text(
                    "LinkedIn",
                    style: formtext,
                  ),
