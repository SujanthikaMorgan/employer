            ...
            child: Container(
             ...
             crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  ...
                  featureAdd('Ad Post Limit : 15', check),
                  featureAdd('Ad expiry in : 60 days', check),
                  featureAdd(' Featured ad fee £10.00 for 14 days',check),
                  featureAdd('Urgent ad fee £5.00 for 14 days', check),
                  featureAdd('Highlight ad fee £5.00 for 14 days',check),
                  featureAdd('Top in search results and category', close),
                  featureAdd('Show ad on home page premium ad section', check),
                  featureAdd('Show ad on home page search result list', close),
                  Padding(
