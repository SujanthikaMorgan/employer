...
import 'package:my_jobs_center/Screens/membership.dart';
          ...
          SingleChildScrollView(
            child: Column(
              children: [
                ...
                _value==true ? Padding(padding: EdgeInsets.only(top: 15,left: 15),
                  child: Column(
                    children: [
                      TextField(
